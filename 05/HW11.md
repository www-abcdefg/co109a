# 第十二週
* CPU
    * [CPU.hdl](https://github.com/www-abcdefg/co109a/tree/master/05/CPU.hdl)
    ```
    ...
    */
    ...
    CHIP CPU {
        ...
        ALU(x=D, y=AorM, zx=instruction[11], nx=instruction[10], zy=instruction[9], ny=instruction[8], f=instruction[7], no=instruction[6], out=outM, out=aluOut, zr=x, ng=ng);
        //writeM-c
...
![picture](https://github.com/www-abcdefg/co109a/blob/master/05/HW11.jpg)