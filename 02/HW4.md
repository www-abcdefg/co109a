# 第五週
* ALU-nostat
    * [ALU-nostat.hdl](https://github.com/www-abcdefg/co109a/blob/master/02/ALU-nostat.hdl)
    ```
    ...
    */
    ...
    ```
* ALU
    * [ALU.hdl](https://github.com/www-abcdefg/co109a/blob/master/02/ALU.hdl)
    ```
    // This file is part of www.nand2tetris.org
    // and the book "The Elements of Computing Systems"
    // by Nisan and Schocken, MIT Press.
    ...
    */
    ...
    // Put you code here:
        ...
        Mux16(a=o1, b=noto1, sel=no, out=o2, out=out, out[0..7]=outa, out[8..15]=outb, out[15]=ng);  // if (no == 1) set out = !out
        Or8Way(in=outa, out=ora);      // ora = Or(out[0..7]);
        Or8Way(in=outb, out=orb);    // orb = Or(out[8..15]);
        Or(a=ora, b=orb, out=notzr);  // nzr = Or(out[0..15]);
        Not(in=notzr, out=zr);             // zr = !nzr

    }
    ```
![picture](https://github.com/www-abcdefg/co109a/blob/master/02/hw4.jpg)